...
export const Header = ({ 
  ...
  return (
    <header className="glass-card sticky top-0 z-50 w-full overflow-x-auto overscroll-x-contain border-x-0 rounded-none px-2 py-2 md:px-4 md:py-2.5">
      <div className="flex min-w-max items-center justify-between gap-2 md:min-w-0 md:gap-4">
        <div className="flex items-center gap-2 md:gap-3 min-w-0">
          <div className="flex items-center gap-1.5 md:gap-2 shrink-0">
            ...
            <h1 className="text-xs md:text-base font-semibold tracking-tight whitespace-nowrap">
              4Asas
            </h1>
          </div>
          ...
          <Button
            ...
            onClick={toggleMode}
            className={cn(
              "h-7 shrink-0 px-2 text-[10px] md:text-xs font-semibold transition-all",
              isRealMode 
          ...
          {isRealMode && (
            <div className="flex items-center gap-1.5 bg-muted/30 rounded-lg px-2 py-1 md:flex">
        ...
        <div className="flex shrink-0 items-center gap-1 md:gap-1.5">
          <Button
            ...
            onClick={onToggleBot}
            className={cn(
              "gap-1.5 h-8 shrink-0 px-2 md:px-3 text-xs transition-all",
              isRunning 
